...
Sqr.prototype.render = function(){
    //console.log(this.d.n);
    if(this.d.n == 1){
        this.d.ctx.save();
        this.d.ctx.beginPath();
        this.d.ctx.moveTo(110,20);
        this.d.ctx.lineTo(190,20);
        ...
        for(var i = 0;i < 2;i++){
            this.d.ctx.save();
            this.d.ctx.beginPath();
            this.d.ctx.moveTo(35+i*150,20);
            this.d.ctx.lineTo(115+i*150,20);
        ...
        for(var i = 0;i < 3;i++){
            this.d.ctx.save();
            this.d.ctx.beginPath();
            this.d.ctx.moveTo(10+i*100,20);
            this.d.ctx.lineTo(90+i*100,20);
